...
.LBB0_3:                                #   Parent Loop BB0_2 Depth=1
	...
	vmovaps	%ymm0, (%rsi,%rdx,4)
	vmovaps	%ymm1, 32(%rsi,%rdx,4)
	vmovaps	%ymm2, 64(%rsi,%rdx,4)
	vmovaps	%ymm3, 96(%rsi,%rdx,4)
	addq	$32, %rdx
	cmpq	$1024, %rdx             # imm = 0x400
	jne	.LBB0_3
