...
// void vertex_set_clear(vertex_set *list,int nodenum)
// {
//     // #pragma omp parallel for
//     // for(int i=0;i<nodenum;i++){
//     //     list->vertices[i]=0;
//     // }
//     list->max_vertices = nodenum;
//     list->vertices = (int *)malloc(sizeof(int) * list->max_vertices);
...
//         vertex_set_clear(new_frontier,graph->num_nodes);
//         vertex_set_clear(bu_new_frontier,graph->num_nodes);
...
//             *p_mfrontier_count+=(end_edge-start_edge);
//             // *p_mfrontier_count+=g->incoming_size(g, i);
...
// #ifdef VERBOSE
//         double end_time = CycleTimer::currentSeconds();
//         printf("frontier=%-10d %.4f sec\n", bu_frontier->count, end_time - start_time);
// #endif
